...
def preprocessImg(img, size):
    ...
    img = np.rollaxis(img, 0, 3)    # Converts to (640, 480, 3)
...
class DoubleDQNAgent:
    ...
    def __init__(self, state_size, action_size):
        ...
        self.mavg_kill_counts = [] # Moving Average of Kills
    ...
    def shape_reward(self, r_t, misc, prev_misc, t):
        ...
        if (misc[1] < prev_misc[1]): # Ammo lost
            r_t = r_t - 0.05

        #if (misc[2] < prev_misc[2]): # Health lost
            #r_t = r_t - 0.1
...
if __name__ == "__main__":
    ...
    game = DoomGame()
    game.load_config("/home/blackmaelstrom/ViZDoom/scenarios/defend_the_center.cfg")
